...
public static class GameLogic
{
    ...
    public static ClickerState CraftShears(ClickerState s) => CanCraftShears(s) ? UpdateInv(s, i => i with { Iron = i.Iron - 5, Log = i.Log - 30 }) with { Upgrades = s.Upgrades with { HasShears = true } } : s;
